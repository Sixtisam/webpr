...
import { Scheduler, DataFlowVariable } from "../dataflow/dataflow.js";
const suite = Suite("dataflow");

console.log("module this", window);

suite.test("dataflow-scheduler", (assert) => {
  const result = [];
...
suite.test("dataflow-value", (assert) => {
...
suite.test("dataflow-cache", (assert) => {
